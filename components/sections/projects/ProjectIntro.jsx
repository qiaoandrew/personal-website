  ...
  return (
    <section className="mb-8 lg:mb-12 2xl:mb-16">
      ...
      <GradientBorder
        ...
        classes="group"
      >
        <div className="gradient-project-light dark:gradient-project-dark relative h-[360px] overflow-hidden rounded-[11px] 3xs:h-[420px] 3xs:rounded-[15px] 2xs:h-[480px] 2xs:rounded-[23px] xs:h-[580x] xl:h-[620px] 2xl:rounded-[35px] 3xl:h-[640px]">
          <div
