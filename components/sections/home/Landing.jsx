...
export default function Landing() {
  return (
    <section className="m-horizontal relative mb-8 lg:mb-14 3xl:mb-24">
      <h1 className="transition-300 3xl:text- mb-4 text-2xl font-semibold text-black dark:text-beige 3xs:mb-5 3xs:text-3xl xs:text-4xl sm:mb-7 sm:text-5xl md:text-7xl lg:text-8xl xl:mb-10 xl:text-9xl 2xl:text-10xl 3xl:mb-12">
        <div>
          Hi. I&apos;m{' '}
