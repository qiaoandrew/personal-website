export default function Landing() {
  return (
    <section className="m-horizontal relative">
      <h1 className="transition-300 mb-4 text-2xl font-[550] text-black dark:text-beige 3xs:mb-6 3xs:text-3xl xs:text-4xl sm:text-5xl md:text-7xl lg:text-8xl xl:mb-10 xl:text-9xl 2xl:text-10xl 3xl:mb-12 3xl:text-11xl">
        <div>
          Hi. I&apos;m{" "}
