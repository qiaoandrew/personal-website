...
function ExperienceCard({ experience }) {
  ...
  return (
    <div className="transition-300 relative h-full overflow-hidden rounded-[11px] bg-beige px-5 pt-5 pb-6 dark:bg-black 3xs:rounded-[15px] 2xs:rounded-[23px] xs:px-6 xs:pt-6 xs:pb-8 sm:px-9 sm:pt-9 sm:pb-10 md:px-5 md:pt-5 md:pb-6 lg:px-6 lg:pt-6 lg:pb-8 xl:px-8 xl:pt-7 xl:pb-10 2xl:rounded-[35px] 2xl:px-10 2xl:pt-10 2xl:pb-12">
      ...
      <div className="relative z-20 mb-3 hidden flex-wrap gap-3 3xs:flex xs:mb-4 xs:gap-4 sm:mb-5 md:mb-3 lg:mb-4 2xl:mb-6 2xl:gap-5">
        ...
        >
          <div className="transition-300 inline-block rounded-full bg-beige px-3 py-1.5 last:mr-0 dark:bg-black xs:px-4 md:px-3 md:py-1.5 xl:px-4">
            <p className="transition-300 text-xs text-darkPurple dark:text-lightPurple xs:text-sm md:text-xs xl:text-sm">
              {experience.duration}
            </p>
          </div>
        </GradientBorder>
