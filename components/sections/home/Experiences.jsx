...
function ExperienceCard({ experience }) {
  return (
    <div className="transition-300 relative h-full overflow-hidden rounded-[11px] bg-beige px-4 py-4 dark:bg-black 3xs:rounded-[15px] 3xs:px-5 3xs:py-5 xs:px-7 xs:py-7 sm:px-10 sm:py-10 md:px-6 md:py-6 xl:rounded-[23px] xl:px-8 xl:py-8 2xl:px-10 2xl:pt-10 2xl:pb-12">
      ...
      <h3 className="relative z-20 mb-1 text-xl font-[550] 3xs:mb-0.5 3xs:text-2xl xs:mb-1 xs:text-3xl sm:mb-2.5 sm:text-4xl md:mb-1 md:text-2xl xl:mb-1.5 xl:text-3xl 2xl:mb-2.5 2xl:text-4xl 3xl:text-5xl">
        <span className="gradient-text gradient-1 dark:gradient-2">
          {experience.role}
        </span>
      </h3>
      <p className="relative z-20 mb-4 text-sm font-[450] text-darkPurple dark:text-purple 3xs:text-base xs:mb-5 xs:text-lg sm:mb-6 sm:text-xl md:mb-4 md:text-base xl:mb-5 xl:text-lg 2xl:mb-7 2xl:text-xl 3xl:mb-8 3xl:text-2xl 4xl:mb-10 4xl:text-3xl">
        {experience.company}
      </p>
      <div className="relative z-20 hidden flex-wrap gap-x-4 gap-y-3 3xs:flex sm:gap-x-6 md:gap-x-4 2xl:gap-x-5 3xl:gap-x-6">
        <div className="flex items-center gap-2 rounded-xl border border-purple bg-beige bg-opacity-40 py-1.5 px-3 dark:border-darkPurple dark:bg-black dark:bg-opacity-30 sm:gap-2.5 sm:rounded-2xl sm:py-2.5 sm:pl-4 sm:pr-4.5 md:gap-2 md:rounded-xl md:py-1.5 md:px-3 2xl:rounded-2xl 2xl:py-2.5 2xl:pl-4 2xl:pr-4.5 3xl:gap-3 3xl:py-3 3xl:pl-5 3xl:pr-6">
          <div className="filter-black dark:filter-purple hidden h-4.5 w-4.5 xs:block sm:h-5 sm:w-5 md:h-4.5 md:w-4.5 2xl:h-5 2xl:w-5">
