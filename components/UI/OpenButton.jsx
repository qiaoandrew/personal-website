...
export default function OpenButton() {
  return (
    <div className="absolute top-3 right-3 z-40 3xs:top-4 3xs:right-4 xs:top-6 xs:right-6 2xl:top-8 2xl:right-8">
      ...
      >
        <div className="gradient-main-dark dark:gradient-main-light grid h-8 w-8 place-content-center rounded-full 3xs:h-12 3xs:w-12 xs:h-14 xs:w-14 sm:h-16 sm:w-16 md:h-12 md:w-12 xl:h-14 xl:w-14 2xl:h-16 2xl:w-16">
